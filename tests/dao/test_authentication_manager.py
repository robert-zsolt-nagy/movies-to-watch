...
class TestAuthenticationManager(TestCase):
    def test_get_authentication_error_msg_returns_message(self):
        ...
        #when
        message = AuthenticationManager.get_authentication_error_msg(error=my_error)
    ...
    def test_sign_in_with_email_and_password_should_return_data(self):
        ...
        under_test = AuthenticationManager(config=auth)
    ...
    def test_update_profile_should_pass_on_information(self):
        ...
        auth.update_profile.assert_called_with(id_token="id", display_name="name", photo_url="/pic.jpg", delete_attribute=None)
